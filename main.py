...
app = Flask(__name__)
CORS(app)
new_model = TFDistilBertForSequenceClassification.from_pretrained('D:\Academics\Semester 7\Final Year Project\Model_API\sentiment_model\sentiment_analyzer_model')
model_name, max_len = pickle.load(open('D:\Academics\Semester 7\Final Year Project\Model_API\sentiment_model\sentiment_analyzer_model\info.pkl', 'rb'))
